<%-- 
    Document   : login
    Created on : Jun 20, 2017, 11:29:58 AM
    Author     : phenom
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="20150569">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form name="loginForm" role="form" action="<c:out value="j_spring_security_check"/>" method="POST">
                                <fieldset>
